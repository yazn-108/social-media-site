...
const NavBar = () => {
    ...
    const [isLogIn, setIsLogIn] = useState(localStorage.getItem("token") !== null ? true : false)
    const dispatch = useDispatch()
    useEffect(() => {
        dispatch({ type: "logInState", state: isLogIn })
    }, [dispatch, isLogIn])
                ...
                <Container>
                    ...
                    <Navbar.Collapse id="navbarScroll">
                        <Nav
                            ...
                            navbarScroll >
                            <Link className="nav-link" to={"/"} href="#action1">Home</Link>
                            {
                                !isLogIn
                                    ? <button style={{ textAlign: "left" }} className="nav-link" onClick={() => setLoginState(true)}>Profile</button>
                                    : <Link className="nav-link" to={"/profile"} onClick={() => dispatch({ type: "userId", id: userInfo.id })}>
                                        Profile
                                    </Link>
                            }
                        </Nav>
                        {
                            !isLogIn ? (
                                <>
                                    <Button variant="outline-success m-1" onClick={() => setLoginState(true)}>log in</Button>
                                    <Button variant="outline-success m-1" onClick={() => setRegisterState(true)}>register</Button>
                                </>
                            ) :
                                <div className='user-actions'>
                                    <p>@{userInfo.username}</p>
                                    <img src={userInfo.profile_image} alt="" />
                                    <Button variant="outline-danger m-1" onClick={() => {
                                        localStorage.clear()
                                        setIsLogIn(false)
